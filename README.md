...
<p align="center">
  <img src="icons/icon-128.png" width="128" height="128" alt="Logo">
</p>
...
This Chrome extension operates as the **GTA VICELAUNCHER Cloud Play Launcher** that launches the game environment and injects a fully interactive GTA V-style virtual smartphone HUD directly on top of the active WebGL rendering canvas.
...
* **In-Game Mobile Mod (VICELAUNCHER)**: Press the Up Arrow key to slide up a beautiful smartphone casing HUD in the bottom-right corner.
...
---
<p align="center">
  <em>Developed with ❤️ and Powered by Mauxx AI</em>
</p>
